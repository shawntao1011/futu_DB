// Customised Segmented TP process
...
generateschemas:{
  ...
  // The original Table UPD functions attach the current timestamp by default
  // Customised UPD function follow the vanila tick convention
